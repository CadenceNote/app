...
interface MultiSelectProps
    ...
    options: {
        ...
        renderInBadge?: (value: string) => React.ReactNode;
    }[];
    ...
    /**
     * Whether to show delete buttons on selected badges.
                                    ...
                                    {selectedValues.slice(0, maxCount).map((value) => {
                                        ...
                                        return (
                                            <div
                                                ...
                                                onClick={(e) => {
                                                    if (showSelectedDelete) {
                                                        e.stopPropagation();
                                                        toggleOption(value);
                                                    }
                                                }}
                                            >
                                                {option.renderInBadge ? (
                                                    option.renderInBadge(value)
                                                ) : (
                                                    <>
                                                        {option.icon && (
