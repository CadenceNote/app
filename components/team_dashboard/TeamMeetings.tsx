        ...
        <div className="relative min-h-[200px]">
            <div className="relative">
                <div className="flex items-center justify-between mb-6">
                    <div>
                        <h2 className="text-2xl font-bold text-gray-900">Team Meetings</h2>
                ...
                <Sheet open={isCreateModalOpen} onOpenChange={handleCreateModalClose}>
                    <SheetContent className="sm:max-w-[540px]">
                        ...
                        <form onSubmit={addMeeting} className="space-y-4 mt-4">
                            ...
                            <Button type="submit" className="w-full bg-indigo-600 hover:bg-indigo-700" disabled={!selectedDate}>
                                Schedule Meeting
                            </Button>
                        </form>
                    </SheetContent>
            ...
            {selectedMeeting && (
                <MeetingParticipantsModal
                    ...
                    onParticipantsUpdate={async () => {
                        const updatedMeetings = await meetingApi.listMeetings(teamId);
